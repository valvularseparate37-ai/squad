...
> **Historical note:** This post describes Squad's first docs overhaul (Wave 3, early 2026). The docs site has since been updated — this wave built the foundation; later posts describe what changed next.
